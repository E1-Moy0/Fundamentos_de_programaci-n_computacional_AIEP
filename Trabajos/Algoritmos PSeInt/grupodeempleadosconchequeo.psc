Algoritmo grupodeempleados
	...
	contadordeptoconta=0
		...
		Escribir "2. No"
		leer opciona
		si opciona<>1 y opciona<>2 Entonces
			...
			Mientras opciona=1 Hacer
				...
				Segun depto Hacer
					1:
						...
						leer sueldo
						si sueldo<>entero y sueldo<0 Entonces
							Escribir "Dato invalido, por favor ingreselo nuevamente."
						SiNo
							si depto=1 Entonces
	...
	si contadordeptoconta>contadordeptoinfo Entonces
		Escribir "Hay ", contadordeptoconta " trabajadores en el departamento de Contabilidad y ", contadordeptoinfo " en el departamentdo de Informatica. Es decir, hay mas trabajadores en el Departamento de Contabilidad."
	SiNo
		si contadordeptoconta=contadordeptoinfo Entonces
		...
		SiNo
			Escribir "Hay ", contadordeptoconta " trabajadores en el departamento de Contabilidad y ", contadordeptoinfo " en el departamentdo de Informatica. Es decir, hay mas trabajadores en el Departamento de Informatica."
		FinSi
	FinSi
    FinSi
FinAlgoritmo
